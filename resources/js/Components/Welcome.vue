...
<template>
  <v-row>
    <v-col xs="12" sm="12" md="12">
      <v-row no-gutters>
        <v-col v-for="n in 4" :key="n" cols="12" xs="12" sm="6" md="3" >
          <div class="flex justify-center text-center p-1 mb-2">
            <v-card width="100%">
              <v-col cols="12" xs="6" sm="12" md="12" >
                <v-card-actions>
                  <v-col cols="6" xs="12" sm="6" md="6" >
                    <h6 class="mb-0">Propostas Enviadas</h6>
                  </v-col>

                  <v-col cols="6" xs="12" sm="6" md="6" >
                    <BarChart :valueNumber="n*4"/>
                  </v-col>
                </v-card-actions>
              </v-col>
            </v-card>
    ...
    <v-col cols="12" md="6">
      ...
      <v-row no-gutters>
        <v-col v-for="n in 3" :key="n">
          <div class="flex justify-center text-center p-1 mb-2">
            <v-card width="100%">
              <v-icon icon="fas fa-edit" class="mt-5"></v-icon>
              <v-card-item>
                <div class="text-slate-400 mt-3">Proposta de hoje</div>
                <div class="text-sky-600 mt-3 text-2xl font-bold">90</div>
              </v-card-item>
            </v-card>
          </div>
        </v-col>
  ...
  <v-row no-gutters>
    <v-col cols="12" md="12">
      <v-card class="mx-auto">
        <v-card-title> Escolha Azul </v-card-title>
        <v-card-subtitle> Dados de todas as propostas </v-card-subtitle>

        <v-card-actions>
          <v-col cols="12" md="3" v-for="n in 4" :key="n">
            <v-sheet>
              <div class="grid grid-cols-2 gap-1 place-content-center">
                <v-card-title>
                  <v-icon class="icon-ea" icon="fa fa-chart-line"></v-icon>
                </v-card-title>
                <v-card-subtitle>
                  Pessoa Física
                  <v-card-title> 23k </v-card-title>
                </v-card-subtitle>
              </div>
            </v-sheet>
          </v-col>
